...
<?php
  ...
  require_once('class/funcionario.php');
    ...
    if(isset($_POST['nome'])) {
        ...
        // Chamar o método para atualizar o funcionario
...
<form class="formulario" action="index.php?p=funcionario&f=atualizar&id=<?php echo $funcionario->idFuncionario; ?>" method="POST" enctype="multipart/form-data">
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" id="funcao" name="funcao"  value="<?php echo $funcionario->funcao; ?>" required>
    
  </div>

  <div class="col-md-3">
        <label  class="form-label">Status</label>
        <input type="text" class="form-control" id="statusfuncionario" name="statusfuncionario"  value="<?php echo $funcionario->statusFuncionario; ?>" required>
