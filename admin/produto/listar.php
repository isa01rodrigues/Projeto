...
<section>
        <div class="btnCadast">
            <!---direciona para a pagina de cadastro-->
                ...
                href="index.php?p=produto&pr=cadastrar">
...
<table class="table table-sm table-dark">
  ...
  <?php foreach ($lista as $linha) : ?>
            ...
            <td><?php echo $linha['statusProduto'] ?></td>
                ...
                <td> 
                <a  href="index.php?p=produto&pr=atualizar&id=<?php echo $linha['idProduto'] ?>" >
                ...
                <td> <a  href="index.php?p=produto&pr=desativar&id=<?php echo $linha['idProduto'] ?>" >
