...
$lista = $pagamento -> ListarPagamento();
...
<section>
        <div class="btnCadast">
            <!---direciona para a pagina de cadastro-->
                ...
                href="index.php?p=pagamento&pag=cadastrar">
...
<table class="table table-sm table-dark">
  ...
  <?php foreach ($lista as $linha) : ?>
            ...
            <tr >
            <td><?php echo $linha['idPagamento'] ?></td>
            <td><?php echo $linha['idVenda'] ?></td>
            <td><?php echo $linha['produto'] ?></td>
            <td><?php echo $linha['FormaPagamento'] ?></td>
            <td><?php echo $linha['subtotal'] ?></td>
            <td><?php echo $linha['valorParcela'] ?></td>
            <td><?php echo $linha['quantidadeParcela'] ?></td>
            <td><?php echo $linha['dataVencimento'] ?></td>
            <td><?php echo $linha['nomeCliente'] ?></td>
            <td><?php echo $linha['statusVenda'] ?></td>

                
                <td> 
                <a  href="index.php?p=pagamento&pag=atualizar&id=<?php echo $linha['idPagamento'] ?>" >
